...
Shader "Vefects/SH_Vefects_VFX_HDRP_Trail_Distortion"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_OpacityMask = packedInput.ase_texcoord2.zw * _OpacityMask_ST.xy + _OpacityMask_ST.zw;
				...
				float screenDepth111 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float4 fetchOpaqueVal9 = ASEHDSampleSceneColor(( appendResult8 + lerpResult33 ), 0.0, GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Color = ( fetchOpaqueVal9 * float4( 0,0,0,0 ) ).rgb;
...
WireConnection;210;0;9;0
WireConnection;202;0;210;0
WireConnection;202;1;9;0
WireConnection;202;2;16;4
ASEEND*/
//CHKSM=950BFAD570043C474FE93D83C865369EFB6C82F4